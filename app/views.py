...
class VyrobekModelView(ModelView):
    ...
    list_columns = ["id", "nazev", "serial__number"]
   

class SkladModelView(ModelView):
    datamodel = SQLAInterface(Sklad)
    list_columns = ["id", "nazev", "datum", "ks", "stav"]
...
appbuilder.add_view(
    VyrobekModelView, "List vyrobku", icon="fa-envelope", category="Vyrobek"
)

appbuilder.add_view(
    SkladModelView, "List skladu", icon="fa-envelope", category="Sklad"
)